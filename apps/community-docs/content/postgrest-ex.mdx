---
title: 'Postgrest Ex'
description: 'Isomorphic Elixir client for PostgREST'
repo: 'postgrest-ex'
repoUrl: 'https://github.com/supabase-community/postgrest-ex'
tags:
  - 'elixir'
  - 'postgrest'
  - 'supabase-postgrest'
...
> This page is generated from [postgrest-ex](https://github.com/supabase-community/postgrest-ex).
