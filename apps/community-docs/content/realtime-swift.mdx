...
description: 'A Swift client for Supabase Realtime server.'
repo: 'realtime-swift'
repoUrl: 'https://github.com/supabase-community/realtime-swift'
tags:
  - 'realtime'
  - 'database'
  - 'postgres'
...
> This page is generated from [realtime-swift](https://github.com/supabase-community/realtime-swift).
