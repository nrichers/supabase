---
title: 'Mock Supabase Http Client'
description: 'A mock HTTP client for mocking Supabase Client in Dart application.'
repo: 'mock_supabase_http_client'
repoUrl: 'https://github.com/supabase-community/mock_supabase_http_client'
tags:
  - 'flutter'
  - 'supabase'
  - 'supabase-client'
...
> This page is generated from [mock_supabase_http_client](https://github.com/supabase-community/mock_supabase_http_client).
