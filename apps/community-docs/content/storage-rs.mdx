---
title: "Storage Rs"
description: "This is a Rust implementation of the [supabase storage client](https://supabase.com/docs/reference/javascript/storage-createbucket). The goal is to have feature parity and an easy-"
repo: "storage-rs"
repoUrl: "https://github.com/supabase-community/storage-rs"
tags:
  - "auth"
  - "storage"
category: "Auth"
...
> This page is generated from [storage-rs](https://github.com/supabase-community/storage-rs).
